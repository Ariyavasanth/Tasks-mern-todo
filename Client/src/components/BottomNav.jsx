...
const BottomNav = ({ onAddClick }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full h-[65px] bg-white border-t flex justify-around items-center z-30">
      ...
      <button
        onClick={onAddClick}
        className="absolute -top-8 left-1/2 -translate-x-1/2 w-(--space-13) h-(--space-13) rounded-full bg-brand-primary text-white text-h4 flex items-center justify-center shadow-lg active:bg-btn-active hover:bg-btn-hover"
      >
        +
      </button>
    </div>
